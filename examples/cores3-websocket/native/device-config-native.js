...
function wifiPrepare() @ "xs_device_config_wifi_prepare";
function wifiDisconnectReason() @ "xs_device_config_wifi_disconnect_reason";
...
export default Object.freeze({baseMac, load, save, clear, restart, wifiPrepare, wifiDisconnectReason, watchdogStart, watchdogFeed, watchdogStop, usbRead, usbWrite});
